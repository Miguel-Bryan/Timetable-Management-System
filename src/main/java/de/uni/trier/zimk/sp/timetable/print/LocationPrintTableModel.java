 ...
 *
 */
public class LocationPrintTableModel extends AbstractTableModel {
	...
	public LocationPrintTableModel(OrganisationalConfiguration configuration, Location location){
